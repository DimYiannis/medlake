  ...
  <div class="min-h-screen pt-36 pb-24" style="background:var(--bg)">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-px px-10" style="background:var(--border)">
      ...
      <div class="px-0 py-10 pr-16" style="background:var(--bg)">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-8" style="color:var(--text-3)">Kontaktdaten</p>
        <div class="space-y-7">
        ...
        <div class="mt-12 pt-10 border-t" style="border-color:var(--border)">
          <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Öffnungszeiten</p>
          <div class="space-y-3">
      ...
      <div class="px-10 py-10" style="background:var(--bg-card)">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-8" style="color:var(--text-3)">Schreiben Sie uns</p>
        <form @submit.prevent="submit" class="space-y-4">
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="text-[12px] tracking-[0.18em] uppercase mb-2 block" style="color:var(--text-3)">Name</label>
            ...
            <div>
              <label class="text-[12px] tracking-[0.18em] uppercase mb-2 block" style="color:var(--text-3)">E-Mail</label>
          ...
          <div>
            <label class="text-[12px] tracking-[0.18em] uppercase mb-2 block" style="color:var(--text-3)">Betreff</label>
            <input v-model="form.subject" type="text" placeholder="Betreff"
              class="w-full text-[15px] px-4 py-3 focus:outline-none transition-colors"
              style="background:var(--bg-input);border:1px solid var(--border);color:var(--text)" />
          </div>
          <div>
            <label class="text-[12px] tracking-[0.18em] uppercase mb-2 block" style="color:var(--text-3)">Nachricht</label>
