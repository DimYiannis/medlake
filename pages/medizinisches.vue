  ...
  <div class="min-h-screen pt-36 pb-24" style="background:var(--bg)">
    ...
    <div class="px-10 max-w-3xl">
      ...
      <div v-if="activeChapter === 'geschichte'" class="space-y-6">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Geschichte des Krafttrainings</p>
      ...
      <div v-if="activeChapter === 'kraft'" class="space-y-6">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Kraftzuwachs & Trainingsprinzipien</p>
        ...
        <div class="mt-8">
          <p class="text-[12px] tracking-[0.2em] uppercase mb-5" style="color:var(--text-3)">Trainingsprinzipien</p>
      ...
      <div v-if="activeChapter === 'alter'" class="space-y-6">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Muskelkraft & Alter</p>
        <p class="text-[17px] leading-[1.85]" style="color:var(--text-2)">
        ...
        <p class="text-[17px] leading-[1.85] mt-6" style="color:var(--text-2)">
      ...
      <div v-if="activeChapter === 'ruecken'" class="space-y-8">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Rückenschmerzen</p>
      ...
      <div v-if="activeChapter === 'ausdauer'" class="space-y-6">
        <p class="text-[12px] tracking-[0.25em] uppercase mb-6" style="color:var(--text-3)">Ausdauertraining</p>
        <p class="text-[17px] leading-[1.85]" style="color:var(--text-2)">
        ...
        <div class="mt-6">
          <p class="text-[13px] tracking-[0.18em] uppercase mb-4" style="color:var(--text-3)">Effekte des Ausdauertrainings</p>
